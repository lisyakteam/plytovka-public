...
const startText = [
    `🌟 Приветики, <b>%USER%</b>!\n`
    + `<b>Я — Плутовка, твой проводник по серверу <a href="https://t.me/LisyakTeam">lisyak.net</a>!</b>\n\n`
    + `Сегодня, <b>%DATE%</b>, вы можете найти Лисяка в <b>Minecraft Java</b>, а в ближайшее время мы появимся в <b>Roblox, Garry's Mod</b> и других играх!\n\n`
    ...
    + `Если у вас ПК, то, например, <a href="https://www.minecraft.net/ru-ru">официальный от Mojang</a>, PrismLauncher или наш новый <a href="https://github.com/LisyakTeam/SkyLoader/releases/1.0.2">SkyLoader Launcher</a>\n\n`
    ...
    `✨ Чтобы зайти на сервер (не через SkyLoader) <b>запустите игру</b>, выберите <b>"Многопользовательский режим"</b> и <b>добавьте сервер</b> - его адрес lisyak.net!`
